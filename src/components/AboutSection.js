            ...
            <div className="about-content">
                ...
                <div className="about-text">
                    ...
                    <div className="goal-box">
                        <p>Моя цель - решать реальные, натурные проблемы современного мира с помощью виртуальных решений,
                        независимо от доменной области и реальных, окружающих нас, ограничений!
                        </p>
                    </div>
                </div>
            </div>
